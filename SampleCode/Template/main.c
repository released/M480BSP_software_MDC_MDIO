...
void MDIO_Verify_PHY_Test(void)
{
    int32_t res = 0;
...
void MDIO_Verify_PHY_Init(void)
{
	
    /***********************************/
    CLK_EnableModuleClock(EMAC_MODULE);
    // Configure MDC clock rate to HCLK / (75 + 1) = 2.5 MHz if system is running at 192 MHz
    CLK_SetModuleClock(EMAC_MODULE, 0, CLK_CLKDIV3_EMAC(75));
...
{    
    software_MDIO_WriteRegister(0x00, 0x01, (1UL << 15UL));
    software_MDIO_WriteRegister(0x01, 0x01, (1UL << 14UL));
    software_MDIO_WriteRegister(0x02, 0x01, (1UL << 13UL));
    software_MDIO_WriteRegister(0x03, 0x01, (1UL << 12UL));
    software_MDIO_WriteRegister(0x04, 0x01, (1UL << 11UL));
    software_MDIO_WriteRegister(0x05, 0x01, (1UL << 10UL));
    software_MDIO_WriteRegister(0x06, 0x01, (1UL << 9UL));
    software_MDIO_WriteRegister(0x07, 0x01, (1UL << 8UL));
    
    software_MDIO_WriteRegister(0x08, 0x08, 0x5A5A);
    software_MDIO_WriteRegister(0x09, 0x09, 0xA5A5);
